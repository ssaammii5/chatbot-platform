...
export const tenantMemberships = pgTable(
  ...
  (t) => ({
    uniqMember: unique('tenant_memberships_tenant_user_unique').on(
      t.tenantId,
      t.globalUserId,
    ),
  }),
...
export const tenantMembershipsRelations = relations(
  ...
  ({ one }) => ({
    ...
    globalUser: one(globalUsers, {
      fields: [tenantMemberships.globalUserId],
...
export const authSessionsRelations = relations(authSessions, ({ one }) => ({
  tenant: one(tenants, {
    fields: [authSessions.tenantId],
    references: [tenants.id],
  }),
  globalUser: one(globalUsers, {
    fields: [authSessions.globalUserId],
    references: [globalUsers.id],
  }),
}));
